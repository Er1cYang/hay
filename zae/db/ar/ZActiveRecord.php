...
$model=ZActiveRecord::model($relations[$seg]->className);
else
break;
}
...
if(!isset($this->_related[$name]))
$this->_related[$name]=array();
if($record instanceof ZActiveRecord)
{
if($index===true)
...
public function setAttributes(ZActiveRecord $parent, $values, $safeOnly = true) {
$this->_isAttributesSet = true;
$this->setAttributesInternal($parent, $values);
return true;
}
protected function setAttributesInternal(ZActiveRecord $parent, $values, $safeOnly = true) {
}
public function getIsAttributesSet() {
return $this->_isAttributesSet;
}
public function validate(ZActiveRecord $parent, $attributes = null, $clearErrors = true) {
if($this->getIsAttributesSet()) {
return $this->validateInternal($parent, $attributes, $clearErrors);
}
return true;
}
protected function validateInternal(ZActiveRecord $parent, $attributes = null, $clearErrors = true) {
return true;
}
public function delete(ZActiveRecord $parent) {
return $this->deleteInternal($parent);
}
protected function deleteInternal(ZActiveRecord $parent) {
return true;
}
public function save(ZActiveRecord $parent, $runValidation = true, $attributes = null) {
if($this->getIsAttributesSet()) {
return $this->saveInternal($parent, $runValidation, $attributes);
}
return true;
}
protected function saveInternal(ZActiveRecord $parent, $runValidation = true, $attributes = null) {
return true;
}
public function mergeWith($criteria,$fromScope=false)
{
...
{
public $through;
public function setAttributesInternal(ZActiveRecord $parent, $value, $safeOnly = true) {
...
public function saveInternal(ZActiveRecord $parent, $runValidation = true, $attributes = null) {
